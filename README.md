...
### Ближайшие обновления / Upcoming Updates
- [ ] **Маршрутизаторы:** Меж-VLAN маршрутизация (Router-on-a-Stick)
- [ ] **Wi-Fi симуляция:** Визуализация зон покрытия точек доступа
- [ ] **Трафик:** Графики загрузки каналов и устройств
- [ ] **Экспорт:** Сохранение схемы в PNG/PDF формат
- [ ] **Шаблоны:** Готовые шаблоны популярных топологий

### Долгосрочные планы / Long-term Plans
- [ ] **Мультиплеер:** Совместная работа над сетью
- [ ] **CLI:** Эмуляция командной строки устройств
- [ ] **Протоколы:** Симуляция OSPF, STP, ARP
- [ ] **Темы:** Светлая/темная тема оформления
- [ ] **i18n:** Поддержка дополнительных языков
...
- Email: your.email@example.com (опционально)
